...
$defaults = [
	...
	'fc1Name' => 'Wandsworth', 'fc1Desc' => 'Battersea, Tooting, Balham. High-value Victorian stock — strong ROI on loft conversions.',                               'fc1Cost' => 'Typical cost: £78k–£100k', 'fc1Url' => '/loft-conversion-wandsworth',
	'fc2Name' => 'Islington',  'fc2Desc' => 'Multiple conservation areas — Barnsbury, Canonbury. We advise on planning status from day one.',                         'fc2Cost' => 'Typical cost: £80k–£100k', 'fc2Url' => '/loft-conversion-islington',
	'fc3Name' => 'Haringey',   'fc3Desc' => 'Crouch End, Muswell Hill — excellent Victorian and Edwardian terraces. Well-suited to dormer conversions.',              'fc3Cost' => 'Typical cost: £72k–£92k',  'fc3Url' => '/loft-conversion-haringey',
];
...
<section class="section section--dark" id="areas">
	<div class="wrap">
		...
		<div class="borough-grid" style="margin-bottom:44px;">
			...
			?>
			<a href="<?php echo esc_url( $borough_url ); ?>" class="borough-pill"><?php echo esc_html( $borough_name ); ?></a>
			<?php endforeach; ?>
		</div>
		<div class="grid-3">
			...
			?>
			<div class="card--dark">
				<h4 style="color:#fff;margin-bottom:6px;"><?php echo esc_html( $feature_name ); ?></h4>
				<p style="color:var(--color-muted);font-size:0.85rem;margin-bottom:10px;"><?php echo esc_html( $feature_desc ); ?></p>
				<div style="font-size:0.8rem;color:var(--color-orange);font-weight:600;margin-bottom:10px;"><?php echo esc_html( $feature_cost ); ?></div>
				<a href="<?php echo esc_url( $feature_url ); ?>" class="btn btn--white" style="font-size:0.8rem;">View <?php echo esc_html( $feature_name ); ?> →</a>
			</div>
			<?php endforeach; ?>
		</div>
	</div>
