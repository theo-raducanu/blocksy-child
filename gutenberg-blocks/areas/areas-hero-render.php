...
<section class="section section--dark" style="padding:190px 0 80px;position:relative;overflow:hidden;">
	...
	<div class="wrap" style="position:relative;z-index:2;">
		<span class="eyebrow"><?php echo blocksy_child_kses_inline($hero['eyebrow']); ?></span>
		<h1 style="color:#fff;max-width:780px;margin:0 0 16px;font-size:clamp(2.2rem,5vw,4rem);font-weight:800;line-height:1.15;"><?php echo blocksy_child_kses_inline($hero['title']); ?></h1>
		<p style="color:rgba(255,255,255,.84);max-width:820px;"><?php echo blocksy_child_kses_inline($hero['subtitle']); ?></p>
		<div class="intro-grid">
			<div class="intro-pill"><?php echo blocksy_child_kses_inline($hero['pillOne']); ?></div>
			<div class="intro-pill"><?php echo blocksy_child_kses_inline($hero['pillTwo']); ?></div>
			<div class="intro-pill"><?php echo blocksy_child_kses_inline($hero['pillThree']); ?></div>
		</div>
	</div>
</section>
